...
import { DeleteEmbeddingsByKnowledgeBaseCommand } from '@contexts/embeddings/application/commands/delete-embeddings-by-knowledge-base/delete-embeddings-by-knowledge-base.command';
...
describe('KnowledgeBaseDeletedListener (embeddings)', () => {
